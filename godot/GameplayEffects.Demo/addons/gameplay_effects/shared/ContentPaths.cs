...
namespace GameplayEffects.GodotAdapter
{
    ...
    public static class ContentPaths
    {
        ...
        public const string Extension = ".ge";
        ...
        /// <c>cards.ge.remap</c> where the editor lists <c>cards.ge</c>, and both mean the same
        /// resource.
        /// </summary>
        ...
        /// <c>"*.ge, data/*.json"</c>. The engine matches these against the path relative to
