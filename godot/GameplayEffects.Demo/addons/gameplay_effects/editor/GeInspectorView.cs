...
namespace GameplayEffects.GodotAdapter
{
    ...
    /// </remarks>
    [Tool]
    public partial class GeInspectorView : Control
    {
        ...
        public void Receive(string name, Godot.Collections.Dictionary payload)
        {
            switch (name)
            {
                case GeProtocol.EntityList:
                    ShowEntities(payload);
                    break;
                case GeProtocol.EntityDetail:
                    ShowDetail(payload);
                    break;
                case GeProtocol.Welcome:
        ...
        private void RequestEntities() => _send?.Invoke(GeProtocol.Entities, new Godot.Collections.Array { string.Empty, string.Empty });

        private void RequestDetail(int entityId) => _send?.Invoke(GeProtocol.Entity, new Godot.Collections.Array { entityId });
