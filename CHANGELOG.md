...
- **A Godot 4.6 addon**, attached to the GitHub release as a zip: a node that drives battles from GDScript, an importer so content reaches exported builds, and an editor dock for problems, tests, card text and live debugging.
...
- The Godot addon has only been installed by its author.
