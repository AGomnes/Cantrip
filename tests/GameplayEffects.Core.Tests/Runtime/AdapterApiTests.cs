...
namespace GameplayEffects.Tests.Runtime
{
    ...
    public sealed class AdapterApiTests
    {
        ...
        public void A_fingerprint_survives_reloading_the_same_content()
        {
            ...
            library.LoadText(Card, "cards.ge");
            ...
            Assert.Equal(first, ContentLibrary.FromText(Card, "cards.ge").Fingerprint);
        ...
        public void A_fingerprint_ignores_edits_that_add_no_definitions()
        {
            ...
            library.LoadText(Card.Replace("deal 6", "deal 9"), "cards.ge");
