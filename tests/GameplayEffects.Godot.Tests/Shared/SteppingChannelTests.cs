...
namespace GameplayEffects.GodotAdapter.Tests.Shared
{
    ...
    {
        private const string File = "res://stepping.ge";
        ...
        private static GeDebugService Started()
        {
        ...
        {
            GeDebugService service = Started();

            GeStepState state = service.Stepping();
        ...
        public void Pausing_holds_a_trigger_and_says_what_it_is()
        {
            ...
            GeStepState held = service.Stepping();
        ...
        public void Stepping_resolves_one_trigger_and_then_says_there_is_nothing_left()
        {
            ...
            GeStepState after = service.Step();
            ...
            GeStepState again = service.Step();
        ...
        public void A_breakpoint_on_an_event_stops_the_game_where_it_was_written()
        {
            ...
            service.Runtime.Execute("deal 1 to enemy");
            GeStepState stopped = service.Stepping();
        ...
        public void A_trigger_that_fails_while_stepping_is_reported_rather_than_thrown()
        {
            ...
            runtime.SpawnEnemy("Slime");
            var service = new GeDebugService(runtime);

            service.Pause();
            runtime.Execute("deal 1 to enemy");

            GeStepState failed = service.Step();
