...
5. **Coverage corpus**: 58 effects from Slay the Spire, Monster Train, Hearthstone, Balatro and Dota 2 so far: 34 work directly, 13 need a workaround and 11 are not expressible yet ([docs/coverage.md](docs/coverage.md)). The design notes aim for about 150.
