...
5. **Coverage corpus**: 84 effects from Slay the Spire, Monster Train, Hearthstone, Balatro, Dota 2, Magic, Inscryption and Dominion so far: 61 work directly, 8 need a workaround and 15 are not expressible yet ([docs/coverage.md](docs/coverage.md)). The design notes aim for about 150.
