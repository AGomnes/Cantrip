...
5. **Coverage corpus**: 68 effects from Slay the Spire, Monster Train, Hearthstone, Balatro, Dota 2 and Magic so far: 42 work directly, 14 need a workaround and 12 are not expressible yet ([docs/coverage.md](docs/coverage.md)). The design notes aim for about 150.
