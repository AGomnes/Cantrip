...
5. **Coverage corpus**: 93 effects from Slay the Spire, Monster Train, Hearthstone, Balatro, Dota 2, Magic, Inscryption, Dominion and Darkest Dungeon so far: 68 work directly, 9 need a workaround and 16 are not expressible yet ([docs/coverage.md](docs/coverage.md)). The design notes aim for about 150.
